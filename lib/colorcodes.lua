...
function colors:setColor(colorname,opacity)
    if love then
        love.graphics.setColor(colors:getColor(colorname,opacity))
    end
end
...
function colors:getColor(colorname,opacity)
    ...
    if colors[colorname]~=nil then
        return colors[colorname][1],colors[colorname][2],colors[colorname][3],opacity
    else
        return 1,1,1,1
    end
end
...
colors:newColor("olive","#808000")
colors:newColor("olivedrab","#6b8e23")
